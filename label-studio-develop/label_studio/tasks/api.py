...
from core.permissions import ViewClassPermission, all_permissions,annotationsPermission,annotationlistPermission
...
class VIT_censorAnnotationAPI(generics.RetrieveUpdateDestroyAPIView):
    permission_classes=[annotationsPermission]
    parser_classes = (JSONParser, FormParser, MultiPartParser)
    ...
    def perform_destroy(self, annotation):
        annotation.VIT_is_censored=False
        annotation.VIT_censor_by=None
        annotation.save()
        
    def get(self, request, *args, **kwargs):
        return super(VIT_censorAnnotationAPI, self).get(request, *args, **kwargs)

    @api_webhook(WebhookAction.ANNOTATION_UPDATED)
    @swagger_auto_schema(auto_schema=None)
    def put(self, request, *args, **kwargs):
        return super(VIT_censorAnnotationAPI, self).put(request, *args, **kwargs)

    @api_webhook(WebhookAction.ANNOTATION_UPDATED)
    def patch(self, request, *args, **kwargs):
        return super(VIT_censorAnnotationAPI, self).patch(request, *args, **kwargs)

    @api_webhook_for_delete(WebhookAction.ANNOTATIONS_DELETED)
    def delete(self, request, *args, **kwargs):
        return super(VIT_censorAnnotationAPI, self).delete(request, *args, **kwargs)


class VIT_assuranceAnnotationAPI(generics.RetrieveUpdateDestroyAPIView):
    permission_classes=[annotationsPermission]
    parser_classes = (JSONParser, FormParser, MultiPartParser)
    ...
    def perform_destroy(self, annotation):
        annotation.VIT_is_assurance=False
        annotation.VIT_assurance_by=None
        annotation.save()
