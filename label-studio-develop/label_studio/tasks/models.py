...
class Annotation(AnnotationMixin, models.Model):
    ...
    VIT_censor_by=models.ForeignKey(
            settings.AUTH_USER_MODEL,
            related_name='censor_annotations',
            on_delete=models.SET_NULL,
            null=True,
            verbose_name=_('censor by'),
            help_text='Last user who censor this annotation',
        )
    VIT_is_censored = models.BooleanField(default=False, verbose_name=_('is censored'))
    
    VIT_assurance_by=models.ForeignKey(
            settings.AUTH_USER_MODEL,
            related_name='assurance_annotations',
            on_delete=models.SET_NULL,
            null=True,
            verbose_name=_('assurance by'),
            help_text='Last user who assurance this annotation',
        )
    VIT_is_assurance = models.BooleanField(default=False, verbose_name=_('is assurance'))
    class Meta:
