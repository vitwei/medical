...
class User(UserMixin, AbstractBaseUser, PermissionsMixin, UserLastActivityMixin):
    ...
    class Meta:
        ...
        permissions = [
    ("projectlist_get", "projectslist_view"),
    ("projectlist_post", "projectslist_create"),
    ("project_get", "projects_view"),
    ("project_del", "projects_delete"),
    ("project_patch", "projects_change"),
    ("project_put", "projects_change"),
    ("project_post", "projects_create"),
    ("projectimport_post", "projects_import_create"),
    ("projectexport_get", "projects_export_view"),
    ("dmaction_get", "project_data_get"),
    ("dmaction_post", "project_data_change"),
    ("dm_annotationlist_get", "annotationlist_view"),
    ("dm_annotationlist_post", "annotationlist_submit"),
    ("dm_annotations_get", "annotations_view"),
    ("dm_annotations_post", "annotations_submit"),
    ("dm_annotations_put", "annotations_submit"),
    ("dm_annotations_patch", "annotations_update"),
    ("dm_annotations_super", "annotations_super"),
    ("dm_labels_get", "labels_view"),
    ("dm_labels_post", "labels_submit"),
    ("dm_labels_put", "labels_submit"),
    ("dm_labels_patch", "labels_update"),
    ("dm_labels_del", "labels_delete"),
]
